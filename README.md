...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-izg0bxi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-izg0bxi.containers.anotherwebservice.com/
...
```
git clone git@github.com:brunocmorais/container-izg0bxi.git
cd container-izg0bxi
```
...
```
docker attach container-izg0bxi
```
